namespace Schemas {
    ...
    [Schema(@"https://developer.kramp.com/fileclaimcheck/2020/03/26",@"FileEntry")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Schemas.AccountId), XPath = @"/*[local-name()='FileEntry' and namespace-uri()='https://developer.kramp.com/fileclaimcheck/2020/03/26']/*[local-name()='TargetInfo' and namespace-uri()='']/*[local-name()='AccountId' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Schemas.AccountName), XPath = @"/*[local-name()='FileEntry' and namespace-uri()='https://developer.kramp.com/fileclaimcheck/2020/03/26']/*[local-name()='TargetInfo' and namespace-uri()='']/*[local-name()='Name' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Schemas.StorageName), XPath = @"/*[local-name()='FileEntry' and namespace-uri()='https://developer.kramp.com/fileclaimcheck/2020/03/26']/*[local-name()='ResourcSourceInfo' and namespace-uri()='']/*[local-name()='BucketName' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Schemas.ResourceName), XPath = @"/*[local-name()='FileEntry' and namespace-uri()='https://developer.kramp.com/fileclaimcheck/2020/03/26']/*[local-name()='ResourcSourceInfo' and namespace-uri()='']/*[local-name()='ResourceName' and namespace-uri()='']", XsdType = @"string")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"FileEntry"})]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Schemas.ClaimCheckProperties", typeof(global::Schemas.ClaimCheckProperties))]
    public sealed class AzureClaimCheck_Copy : Microsoft.XLANGs.BaseTypes.SchemaBase {
